...
#
#   (1) You need a JAVA_HOME variable in your environment to point to
#       a valid Java installation.
#
#   (2) Gradle requires that your JAVA_HOME is set before running the build.
#
##############################################################################
...
# This is reliable for POSIX systems; use this...
